...
config.DATASET.NUM_USED_JOINTS = 17
config.DATASET.NUM_VIEWS = 4
...
# totalcapture dataset specific
config.MULTI_CAMS = edict()
config.MULTI_CAMS.SELECTED_CAMS = [0, 1, 2, 3, 4, 6]
